...
public class UserController {
    ...
    @Autowired
    public UserController(CartRepository cartRepository, ProductService productService, OrderRepository orderRepository, PersonRepository personRepository, RoleRepository roleRepository) {
